...
public class GlobalVariables {
  ...
  public static double UpperVelocitySetXSpot = 17150.0;//currently testing the balls for this 7000.0
  public static double LowerVelocitySetXSpot = 9650.0;//this is the starting position for tomorow  9000.0;//
