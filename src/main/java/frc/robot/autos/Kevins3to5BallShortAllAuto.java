  ...
  public Kevins3to5BallShortAllAuto(SwerveSubsystem s_Swerve, HarvestorSubsystem m_harvestor, ConveyorSubsystem m_conveyor, ShooterSubsystem m_shooter, PneumaticsSubsystem m_pneumatics){
    ...
    Trajectory tarjectoryPart4 =
        TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(Units.inchesToMeters(-20), Units.inchesToMeters(220), new Rotation2d(Units.degreesToRadians(110))),
            config);
            ...
            TrajectoryGenerator.generateTrajectory(
                ...
                // End 3 meters straight ahead of where we started, facing forward
                new Pose2d(Units.inchesToMeters(5), Units.inchesToMeters(45), new Rotation2d(Units.degreesToRadians(-30))),
                config);
